...
if ( ! class_exists( 'Worky_Widget_Area' ) ) {

	class Worky_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'worky-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'worky-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'worky-theme/widget_area/classes', $classes, $area_id );
	...
	function worky_widget_area() {
		return Worky_Widget_Area::get_instance();
	}
