...
function worky_main_menu() {
	...
	<nav id="site-navigation" class="<?php echo join( ' ', $classes ); ?>" role="navigation">
		...
		<?php
			$args = apply_filters( 'worky-theme/menu/main-menu-args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'worky_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'worky' ),
			) );
 ...
 * @return void
 */
function worky_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'worky-theme/menu/footer-menu-args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'worky' ),
		) );
 ...
 * @return string
 */
function worky_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'worky-theme/social/list-args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'worky_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'worky' ),
	), $context, $type );
